...
import numpy as np
from operators.operators import RHS, solve_poisson_equation_two_stream, J_matrix
...
if __name__ == '__main__':
    ...
    # save results
    np.save("data/SW_sqrt/bump_on_tail/poisson/sol_midpoint_u_" + str(Nv), sol_midpoint_u)
    np.save("data/SW_sqrt/bump_on_tail/poisson/sol_midpoint_t_" + str(Nv), t_vec)
