...
def dydt(y, t):
    ...
    if closure == "energy_local":
        # energy closure
        closure_e = closure_energy_local(state=state_e, alpha_s=alpha_e, u_s=u_e, Nv=Nv, Nx=Nx)
        closure_i = closure_energy_local(state=state_i, alpha_s=alpha_i, u_s=u_i, Nv=Nv, Nx=Nx)
