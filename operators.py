...
def linear_2_SW(state_e, state_i, alpha_e, alpha_i, Nx, Nv, q_e=-1, q_i=1):
    ...
    :return: L_{2}(x, t=t*)
    """
    term1 = np.zeros(2 * Nx + 1)
    term2 = np.zeros(2 * Nx + 1)
    for m in range(Nv):
...
def solve_poisson_equation_two_stream(state_e1, state_e2, state_i, alpha_e1, alpha_e2, alpha_i, Nx, Nv, L, u_e1, u_e2, u_i, solver="SWSR"):
    """
    :param state_e1: a matrix of electron coefficients (species 1) at time t=t*
    :param state_e2: a matrix of electron coefficients (species 2) at time t=t*
    :param state_i: a matrix of ion states at time t=t*
...
def solve_poisson_equation(state_e, state_i, alpha_e, alpha_i, Nx, Nv, L, u_e, u_i, solver="SWSR"):
    """
